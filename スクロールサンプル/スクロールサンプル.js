...
if (reversed == null) { reversed = false; }
	...
	this.instance_16 = new lib.CachedBmp_102();
	...
	this.instance_19 = new lib.CachedBmp_100();
	this.instance_19.setTransform(150.15,1438.15,0.5,0.5);

	this.instance_20 = new lib.CachedBmp_99();
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function drag(event) {
			...
			// デバッグ情報をテキストボックスに表示
			updateLog(prevX, prevY, tempNewX, tempNewY);
