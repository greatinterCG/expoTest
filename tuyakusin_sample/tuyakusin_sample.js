...
}).prototype = getMCSymbolPrototype(lib.Ellipse_2, rect = new cjs.Rectangle(0,0,22,22.1), [rect]);
...
}).prototype = getMCSymbolPrototype(lib.Ellipse_1, rect = new cjs.Rectangle(0,0,22.1,22.1), [rect]);
...
}).prototype = getMCSymbolPrototype(lib.Ellipse, rect = new cjs.Rectangle(0,0,22,22.1), [rect]);
...
}).prototype = getMCSymbolPrototype(lib.ClipGroup, rect = new cjs.Rectangle(0,0,1080,73.2), [rect]);
...
}).prototype = getMCSymbolPrototype(lib.シンボル1, rect = new cjs.Rectangle(-103.1,-103.1,206.2,206.2), [rect]);
...
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect=new cjs.Rectangle(0,0,22,22.1), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect=new cjs.Rectangle(0,0,79,22.1), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect=new cjs.Rectangle(0,0,136,22.1), rect, rect, rect, rect, rect, rect, rect, rect, rect, rect];
...
}).prototype = getMCSymbolPrototype(lib.green, rect = new cjs.Rectangle(0,0,206.3,206.4), [rect]);
...
p.nominalBounds = rect = new cjs.Rectangle(585,1266,1170,2532);
p.frameBounds = [rect, new cjs.Rectangle(585,1266,1724.2,2532)];
// library properties:
lib.properties = {
